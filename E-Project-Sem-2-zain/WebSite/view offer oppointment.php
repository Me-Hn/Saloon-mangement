...
<body>
    <div class="invoice-box">
        ...
        <form action="" method="post">
            <?php
            if (isset($_SESSION['finalcard']) && !empty($_SESSION['finalcard'])) {
                foreach ($_SESSION['finalcard'] as $key => $val) {
                    ?>
                    <div class="information">
                        <div class="client-details">
                            <strong>Bill To:</strong><br>
                            Client ID : <?php echo $val['did']; ?><br>
                            Client Name : <?php echo $val['dname']; ?><br>
                            Client Phone no : <?php echo $val['dphone'] ?>
                        </div>
                        <div class="invoice-details">
                            Date: <?php echo $val['ddate'] ?><br>
                            Slote Timming: <?php echo $val['dslote'] ?>
                        </div>
                    </div>
